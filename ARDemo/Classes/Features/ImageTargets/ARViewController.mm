...
//                                               object:nil];
    ...
    NSLog(@"interfaceOrientation %ld", (long)[[UIApplication sharedApplication] statusBarOrientation]);
    [vapp initAR:Vuforia::GL_20 orientation:[[UIApplication sharedApplication] statusBarOrientation] flags:initFlag];
}
...
- (void)viewDidLoad {
    ...
    NSString * cameraButtonPath = [[[NSBundle mainBundle] resourcePath ]stringByAppendingString:@"/ARResources.bundle/camera.png"];
    UIImage *cameraIconImg = [UIImage imageWithContentsOfFile:cameraButtonPath];
    cameraButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [cameraButton setFrame:CGRectMake(CGRectGetWidth(self.view.bounds) / 4 - 80 / 2, CGRectGetHeight(self.view.bounds) / 2 - 130, 80, 80)];
    [cameraButton setImage:cameraIconImg forState:UIControlStateNormal];
